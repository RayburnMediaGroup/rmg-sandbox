  ...
  return (
    <AudioPlayerProvider>
      ...
      <div style={{
        ...
        <span style={{ fontSize: "0.68rem", letterSpacing: "0.1em", color: "rgba(232,232,232,0.25)", textTransform: "uppercase" }}>
          {dirty ? "saved." : `Preview · ${artist.name}`}
        </span>
